...
public enum SuccessCode {
	...
	ROLE_ASSIGN_REQUEST_OK(HttpStatus.OK.value(), "기업 승인 요청에 성공했습니다."),
	...
	BUILDING_AND_FLOOR_LIST_OK(HttpStatus.OK.value(), "건물 및 층수 리스트 조회에 성공했습니다."),
	...
	PIPELINE_PROPERTY_LIST_OK(HttpStatus.OK.value(), "단일 파이프라인 속성 리스트 조회에 성공했습니다."),
	...
	PIPE_DEFECT_MODIFIED_OK(HttpStatus.OK.value(), "객체 파이프 결함 정보 수정에 성공했습니다."),
	;
