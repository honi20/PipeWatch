...
public interface PipelineModelApiSwagger {
	...
	ResponseEntity<?> fileUpload(@AuthenticationPrincipal Long userId, @RequestPart(value = "modeling-file") MultipartFile modelingFile, @RequestPart(value = "preview-file", required = false) MultipartFile previewFile) throws IOException, ParseException;
